...
declare const VDataIterator: {
    ...
    }, "v-slot:default" | "$children" | "v-slots" | "items" | "v-slot:header" | "v-slot:no-data" | "v-slot:footer">, vue.VNodeProps & vue.AllowedComponentProps & vue.ComponentCustomProps & {
        style: vue.StyleValue;
        tag: string;
        loading: boolean;
        sortBy: readonly SortItem[];
    ...
    'update:expanded': (value: any) => boolean;
    'update:currentItems': (value: any) => boolean;
}, "v-slot:default" | "$children" | "v-slots" | "items" | "v-slot:header" | "v-slot:no-data" | "v-slot:footer">, string, {
    style: vue.StyleValue;
    tag: string;
    loading: boolean;
    sortBy: readonly SortItem[];
